...
- система завершает процесс с максимальным потреблением памяти 

Как бы вы решили данную проблему?
- Для предотвращения сбоев необходимо ограничить ресурсы PostgreSQL или увеличить объем оперативной памяти, можно изменить параметры конфигурации такие как shared_buffers , work_mem , maintenance_work_mem , effective_cache_size  
